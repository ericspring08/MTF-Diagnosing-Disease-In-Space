...
model_options = {
    ...
    'CatBoostAccuracy': CatBoostClassifier(eval_metric='Accuracy', thread_count=-1),
    'CatBoostAUC': CatBoostClassifier(eval_metric='AUC', thread_count=-1),
    'CatBoostCrossEntropy': CatBoostClassifier(eval_metric='CrossEntropy', thread_count=-1),
    'CatBoostF1': CatBoostClassifier(eval_metric='F1', thread_count=-1),
    'CatBoostLogloss': CatBoostClassifier(eval_metric='Logloss', thread_count=-1),
    'CatBoostMCC': CatBoostClassifier(eval_metric='MCC', thread_count=-1),
    'CatBoostPrecision': CatBoostClassifier(eval_metric='Precision', thread_count=-1),
    'CatBoostRecall': CatBoostClassifier(eval_metric='Recall', thread_count=-1),
